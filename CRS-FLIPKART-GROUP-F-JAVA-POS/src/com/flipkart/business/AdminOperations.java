...
public class AdminOperations {
	...
	public AdminOperations() {
		...
		admins.add(new Admin("harshitgarg","Harshit Garg","admin","asdf","29/7/2024"));

		courseCatalogue = new ArrayList<>();
		courseCatalogue.add(new Course("F101","C1",null,10,10,true));
		courseCatalogue.add(new Course("F102","C2",null,10,5,true));
		courseCatalogue.add(new Course("F103","C3",null,10,3,true));
		courseCatalogue.add(new Course("F104","C4",null,10,10,true));
	}
